...
exports.default = allianceTiering;
/**
...
function filterAlliance(alliance) {
    var _a;
    let nations = [];
    let filteredAlliance = (_a = alliance.nations) === null || _a === void 0 ? void 0 : _a.filter((nation) => nation.alliance_position != "APPLICANT" && nation.vacation_mode_turns == 0);
