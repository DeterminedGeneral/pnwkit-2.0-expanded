...
exports.default = bulletinReplyQuery;
const GraphQL_1 = __importDefault(require("../../services/GraphQL"));
function bulletinReplyQuery(params, query, paginator) {
  ...
  `, this.apiKey);
        ...
        if (paginator)
            return res.data.bulletin_replies;
        return res.data.bulletin_replies.data;
    });
}
